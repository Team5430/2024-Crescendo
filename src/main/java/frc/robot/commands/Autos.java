...
public class Autos {
    ...
    public static Command autoRight(driveTrain drive, shooterSub shoot, intakeSub intake) {
    return Commands.sequence(
     ...
     intake.C_intake(),//makes sure the note is correctly in place
      ...
      //drive.C_driveinInches(-18.95),//No idea how this got here, leaving this here just in case
      //rive.C_turntoAngle(73.78)//somebody needed it
          );
 
  }

  public static Command autoLeft(driveTrain drive, shooterSub shoot, intakeSub intake) {
     return Commands.sequence(
  ...
  public static Command autoCenter(driveTrain drive, shooterSub shoot, intakeSub intake) {
        return Commands.sequence(
